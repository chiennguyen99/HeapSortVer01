...
public class Grapdemo extends javax.swing.JFrame {
    ...
    Timer TimeNextPage0To3 = new Timer(1000, new ActionListener() {
        @Override
    ...
    int count1 = 0;
    Timer TimePage4 = new Timer(2000, new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            if (count1 == 0) {
                EffectMovedOnPage(4);
    ...
    int count2 = 0;
    Timer TimePage5 = new Timer(1000, new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            if (count2 == 0) {
                EffectMovedOnPage(5);
    ...
    int count3 = 0;
    Timer TimePage6 = new Timer(1000, new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            if (count3 == 0) {
                EffectMovedOnPage(6);
    ...
    int count4 = 0;
    Timer TimePage7 = new Timer(1000, new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            if (count4 == 0) {
                EffectMovedOnPage(7);
    ...
    int count5 = 0;
    Timer TimePage8 = new Timer(1000, new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            if (count5 == 0) {
                EffectMovedOnPage(8);
    ...
    int count6 = 0;
    Timer TimePage9 = new Timer(1000, new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            if (count6 == 0) {
                EffectMovedOnPage(9);
